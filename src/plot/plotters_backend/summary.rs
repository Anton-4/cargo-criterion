...
pub fn line_comparison(
    ...
    match axis_scale {
        ...
        AxisScale::Logarithmic => draw_line_comparison_figure_log(
            colors, root_area, &unit, x_range, y_range, value_type, lines,
        ),
    }
}
...
fn draw_line_comparison_figure_log(
    colors: &Colors,
    root_area: DrawingArea<SVGBackend, Shift>,
    y_unit: &str,
    x_range: Range<f64>,
...
pub fn violin(
    ...
    match axis_scale {
        ...
        AxisScale::Logarithmic => {
            draw_violin_figure_log(colors, root_area, &unit, x_range, y_range, lines)
        }
    }
}

fn draw_violin_figure(
    colors: &Colors,
    root_area: DrawingArea<SVGBackend, Shift>,
    unit: &str,
    x_range: Range<f64>,
